...
public class Login extends AppCompatActivity {
    ...
    private SessionManager session = new SessionManager(getApplicationContext());
    ...
    private void checkLogin(final String email, final String password){
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, Config_URL.base_URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error){
                ...
                Toast.makeText(Login.this, "Please Check Your Network Connection", Toast.LENGTH_LONG).show();
                hideDialog();
            }
        }){
